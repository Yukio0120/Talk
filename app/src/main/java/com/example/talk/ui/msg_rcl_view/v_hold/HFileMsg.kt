...
import com.example.talk.utilits.WRITE_FILES
import com.example.talk.utilits.asTime
import com.example.talk.utilits.checkPermission
import com.example.talk.utilits.showToast

import kotlinx.android.synthetic.main.msg_i_file.view.*
import java.io.File

class HFileMsg(view: View) : RecyclerView.ViewHolder(view), MsgHolder {
